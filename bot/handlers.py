...
async def cmd_start(message: Message, state: FSMContext) -> None:
    ...
    await message.answer(
        "👋 Добро пожаловать в <b>Шале Релакс</b> — домики у подножия Эльбруса!\n\n"
        "Я помогу вам узнать всё о нашем месте и Приэльбрусье. "
        "Нажмите кнопку ниже или задайте вопрос текстом.",
