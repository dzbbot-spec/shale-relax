    ...
    <div style={{ minHeight: '100dvh', backgroundColor: '#ffffff' }}>
      ...
      <div style={{ margin: '0 12px 16px', padding: '14px 16px', borderRadius: 12, backgroundColor: '#f5f5f5' }}>
        <p style={{ margin: 0, fontSize: 13, fontWeight: 300, color: '#444444', lineHeight: 1.7 }}>
          Два уютных шале у подножия Эльбруса — на высоте 1800 метров, в тишине горного посёлка.
          Просыпайтесь с видом на двуглавую вершину, дышите чистым воздухом Кабардино-Балкарии
          и за пять минут пешком оказывайтесь у подъёмников.
          Здесь нет суеты — только горы, покой и настоящий отдых.
        </p>
      </div>
    </div>
  )
